...
def test_pencil_beam_kernel(benchmark, default_machine_config, default_number_of_cps, default_dtype, default_ct_array_shape, default_device, pencil_beam_kernel_layer):
