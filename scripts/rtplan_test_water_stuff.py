...
machine_config = MachineConfig(preset="src/pydose_rt/data/machine_presets/umea_6MV.json", resolution=patient.voxel_spacing_mm, ct_array_shape=patient.ct_array.shape)
