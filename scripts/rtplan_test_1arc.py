...
# scale = np.quantile(dose_volume[masks["PTVT_42.7"] > 0], 0.01) / np.quantile(dose_pred[0, masks["PTVT_42.7"] > 0], 0.01)
...
res = result_validation(patient, machine_config, treatment, dose_pred, leafs, jaws, mus, compute_gamma=False, compute_clinical_criteria=True)
